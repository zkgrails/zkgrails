selenium {
	...
	url = "http://localhost:8081/zk"				// the base URL for tests, defaults to Grails server url
    defaultTimeout = 80000  						// the timeout after which selenium commands will fail
